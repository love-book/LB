...
type Helper struct {
	Id                int
	Sid               int
	Qrcode			  string 	`orm:"size(255);" form:"Qrcode"`
	Uin               int    	`orm:"size(64);" form:"Uin" valid:"Required"`
	UserName          string  	`orm:"size(64);" form:"UserName" valid:"Required"`
	...
	PYInitial         string	`orm:"size(64);" form:"PYInitial" `
	PYQuanPin         string	`orm:"size(64);" form:"PYQuanPin" `
	RemarkPYInitial   string	`orm:"size(64);" form:"RemarkPYInitial" `
	RemarkPYQuanPin   string	`orm:"size(64);" form:"RemarkPYQuanPin" `
