var contentHtml = '<div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">';
 contentHtml += '<h2 class="sub-header">往期开奖结果</h2>'
  +'<div class="table-responsive">'
  +'<table id="table-my" class="table table-striped">'
  +'</table>'
  +'</div>'
  +'<div class="table-responsive">'
  ...
  var table  = $('#table-my').DataTable({
       ...
       "destory": true,
       "ajax": {
           "url": '/lottery/userlotterylist.html',
      ...
      "columns": [
         ...
         {"data": "lottery_id", title:"开奖编号"},
         {"data": "lettery_money", title:"下注金额"},
         ...
         {"data": "is_winning",title:"是否中奖",render: function(data, type, row, meta) {
        	if(data=="2"){
           		return "已中奖";
           	}else{
           		return "未中奖";
         ...
         {"data": "created_at",title:"下注时间",render: function(data, type, row, meta) {
         	return getLocalTime(data);
         }},
         {"data": "select_name",title:"下注的水果"},
      ],
     "columnDefs": [],
 ...
 var tableAccount  = $('#table-account').DataTable({
     "processing": true,
     "serverSide": true,
     "searching": false,
     "ordering": false,
     ...
     "destory": true,
     "ajax": {
         "url": '/lottery/useraccountlist.html',
         "type": "post",  // method  , by default get
         "error": function () {  // error handling
    ...
    "columns": [
       {"data":null,title:"排序","bSortable": false},
       {"data": "uid", title:"编号"},
       {"data": "uname", title:"下注金额"},
       {"data": "money", title:"money"},
       {"data": "desc", title:"desc"},
       {"data": "type",title:"是否开奖",render: function(data, type, row, meta) {
        	if(data=="1"){
        		return "guanliyuan";
        	}else{
        		return "未开奖";
 ...
 tableAccount.on('draw',function() {
	 tableAccount.column(0, {
	       search: 'applied',
	       order: 'applied'
	   }).nodes().each(function(cell, i) {
	       //i 从0开始，所以这里先加1
